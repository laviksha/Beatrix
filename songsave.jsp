...
<body>
	...
	int counter=5;
	String itemName="",itemName1="",song_name1="",release_date="",album="",artist="",artist2="";
			...
			if (!item.isFormField())
			{
				try 
				{
					...
					if(item.getFieldName().equals("uploadpic"))
					{
						...
						//artist2=savedFile.toString();
						//artist=s2.Artist(artist2);
					}
	...
	s1.addRecord(song_id,itemName,release_date,album,itemName1,song_name1,counter,artist);
	s2.transferid(song_id);
